...
class DbClassOrder implements DbClass {
     ...
     */
    public void submitOrder(CustomerProfile custProf, Order ord) throws DatabaseException {
    	...
    	Address billingAddress = order.getBillAddress();
...
private void populateOrderItems(ResultSet rs) throws DatabaseException {
    	...
    	try{
    		while(rs.next()){
    			...
    			OrderItemImpl item = new OrderItemImpl("TODO", quantity, price);
    ...
    private void populateOrderData(ResultSet resultSet) throws DatabaseException { 
        ...
        try {
            while(resultSet.next()){
            	...
            	System.out.println("populate orderata: "+orderId);
            	System.out.println("populate orderdata in DbClassOrder: "+amount);
            	System.out.println("populate orderdata in DbClassOrder: "+localDate);
